...
Performance* Performance::getInstance() {
	// Use a function-local static to avoid heap allocation and the
	// associated memory leak. The object is destroyed automatically
...
// instance pointer removed: getInstance() now uses a function-local static
